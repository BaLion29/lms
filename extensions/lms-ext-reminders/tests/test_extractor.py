"""Plugin-specific tests for lms-ext-reminders — proposal parsing, prompt snippet."""

from __future__ import annotations

import asyncio

from lms_ext_reminders.extract import ReminderExtractPlugin, ReminderProposal
