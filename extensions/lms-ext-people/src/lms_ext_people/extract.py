...
Part of the lms-ext-people reference extension.
...
Registered via the ``lms.ingestd.extractors`` entry point.
"""
...
from lms_core.plugins import EntityIndex, ExtractorPlugin, ModuleRequirement
