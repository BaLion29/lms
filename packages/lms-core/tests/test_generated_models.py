...
These are the same tests as test_models.py but import from lms_core.generated
instead of lms_core.models, proving the codegen output is equivalent.
"""
...
from lms_core.generated.inbox import (
    InboxNote,
    InboxNoteStatus,
)
...
from lms_core.base import _format_datetime
