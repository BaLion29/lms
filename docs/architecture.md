...
| **queryd** | GraphQL read proxy — document lookup, find entity|class|field, schema introspection, and flag-gated write-tool endpoints. Consumed by mcpd (and webui for health/reads). No embedded LLM. | 8087 |
